...
/* Method 1: Math 
    ...
    总分发人数: x: x * (x + 1) <= candies * 2 ========> x <= sqrt(0.25 + 2 * candies) - 0.5
    完整分发轮数: turns: x / people
    完整轮数应发放糖果: res[i] = (i + 1) * (turns + turns * turns) / 2
    多余人数：reamins = x % people
    多余一轮开始糖果数: turns * people + 1
*/
